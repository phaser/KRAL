	    ...
	    foreach (package ${PACKAGES})
            if (EXISTS "${package}/${dep}")
                ...
                if (NOT EXISTS "${CMAKE_BINARY_DIR}/${dep}")
                    ...
                    message("LIB_TO_BE_LINKED: ${LIB_TO_BE_LINKED}")
                    if (NOT "${LIB_TO_BE_LINKED}" STREQUAL "")
                        set ("${dep}-lib-name" ${LIB_TO_BE_LINKED} CACHE INTERNAL "${${dep}-lib-name}" FORCE)
                        set (LIB_TO_BE_LINKED "" CACHE INTERNAL "LINK" FORCE)
                    endif()
                endif()
